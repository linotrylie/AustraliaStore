<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:93:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\product_controller\index.html";i:1557833948;s:82:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\template\base.html";i:1557451655;s:93:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\template\javascript_vars.html";i:1557451654;s:92:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\product_controller\form.html";i:1557833948;s:90:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\product_controller\th.html";i:1557834725;s:90:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\product_controller\td.html";i:1557834560;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="product_name" name="product_name" value="<?php echo \think\Request::instance()->param('product_name'); ?>" >
...
<th width=""><?php echo sort_by('unit_price','unit_price'); ?></th>
<th width="">unit_quantity</th>
<th width="">in_stock</th>
<th width="">create_time</th>
            <th width="70">操作</th>
        </tr>
        </thead>
        <tbody>
...
<td><?php echo high_light($vo['product_name'],\think\Request::instance()->param('product_name')); ?></td>
<td><?php echo $vo['unit_price']; ?></td>
<td><?php echo $vo['unit_quantity']; ?></td>
