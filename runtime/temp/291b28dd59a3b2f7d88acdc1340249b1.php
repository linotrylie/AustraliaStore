<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\admin_node\edit.html";i:1557451659;s:82:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\template\base.html";i:1557451655;s:93:"D:\wwwroot\AustraliaStore\public_html/../application/admin\view\template\javascript_vars.html";i:1557451654;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    $(function () {
        $('select[name="group_id"]').on('change',function(){
            if($(this).val()){
                $('input[name="pid"]').val() == 0 ? $('input[name="pid"]').val(1) : '';
                $('input[name="level"]').val() == 1 ? $('input[name="level"]').val(2) : '';
            }
        });
